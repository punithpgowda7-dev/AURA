...
const firebaseConfig = {
  apiKey: "AIzaSyBlKE0HId81D3QlmoywOZ_GMTiXnHTSwsc",
  authDomain: "aura-1405.firebaseapp.com",
  projectId: "aura-1405",
  storageBucket: "aura-1405.firebasestorage.app",
  messagingSenderId: "65665000301",
  appId: "1:65665000301:web:62ff4b0f2063d66f85f064"
};
...
export default function Home() {
  ...
  const saveToCloud = async (email: string, history: ChatSession[]) => {
    if (!email || firebaseConfig.apiKey.includes("PASTE")) return; 
    try {
